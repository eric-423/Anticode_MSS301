...
const LockIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v2H4a2 2 0 00-2 2v6a2 2 0 002 2h12a2 2 0 002-2v-6a2 2 0 00-2-2h-2V6a4 4 0 00-4-4zm2 6V6a2 2 0 10-4 0v2h4z" clipRule="evenodd" />
    </svg>
);
        ...
        <div className="w-full max-w-4xl p-8 space-y-8 bg-white rounded-lg shadow-md">
            <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                readOnly
                            />
                            <button type="button" className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm font-semibold text-orange-600 hover:text-orange-500">
                                Thay đổi
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        <label htmlFor="password" className="text-sm font-medium text-gray-700 block mb-2">Mật khẩu</label>
                        <div className="relative">
                            ...
                            <button type="button" className="absolute inset-y-0 right-8 pr-3 flex items-center text-sm font-semibold text-orange-600 hover:text-orange-500">
                                Thay đổi
                            </button>
