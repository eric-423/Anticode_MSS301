  ...
  return (
    <div className="py-[48px] px-[16px] w-[1280px] mx-auto">
      <div className="flex items-center mb-8">
        ...
        <h1 className="font-nunito-sans font-medium text-xl text-start text-[#4A4A4A] mr-10">
          TRANG CHỦ
        </h1>
      </div>
      ...
      <div>
        <div class="text-sm">
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            <span className="text-[#485FC7] font-bold">Galaxy Cinema</span> còn
          ...
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            <span className="italic text-[#485fc7]">phim hay nhất</span>,{" "}
            <span className="italic text-[#485fc7]">phim mới nhất</span> đang
            chiếu hoặc sắp chiếu luôn được cập nhật thường xuyên.{" "}
            <span className="italic text-[#485fc7]">Lịch chiếu</span> tại tất cả
            hệ thống{" "}
            <span className="italic text-[#485fc7]">rạp chiếu phim</span> của
          ...
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            <span className="text-[#485FC7] font-bold">Galaxy Cinema</span>. Quý
            khách có thể dùng tin nhắn lấy vé tại quầy vé của{" "}
            <span className="text-[#485FC7] font-bold">Galaxy Cinema</span> hoặc
          ...
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            <span className="italic text-[#485fc7]">Trang Chủ</span>. Chỉ cần
          ...
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            như <span className="italic text-[#485fc7]">Phim Sắp Chiếu</span>{" "}
            tại <span className="italic text-[#485fc7]">rạp chiếu phim</span>{" "}
            bằng cách vào mục{" "}
            <span className="italic text-[#485fc7]">Bình Luận Phim</span> ở{" "}
            <span className="italic text-[#485fc7]">Góc Điện Ảnh</span> để đọc
          ...
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            <span className="italic text-[#485fc7]">ưu đãi</span>, quà tặng vô
          ...
          <p className="text-[14px] font-nunito-sans mt-[8pt]">
            ...
            mỗi tháng,{" "}
            <span className="text-[#363636] font-bold">Galaxy Cinema</span> cũng
            giới thiệu các{" "}
            <span className="italic text-[#485fc7]">phim sắp chiếu</span> hot
            nhất trong mục{" "}
