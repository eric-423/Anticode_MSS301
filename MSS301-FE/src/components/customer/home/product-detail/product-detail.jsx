            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 max-w-6xl mx-auto">
                    ...
                    <div className="product-details flex flex-col justify-center">
                        ...
                        <p className="text-3xl lg:text-4xl font-medium text-orange-500 mb-6">{productData.price}</p>

                        <div className="quantity-section mb-6">
                            <label htmlFor="quantity" className="block text-base font-medium text-gray-700 mb-2">Số lượng</label>
                            <div className="flex items-center border border-gray-300 rounded-md w-fit">
                                <button
                                    onClick={handleDecreaseQuantity}
                                    className="quantity-btn px-4 py-2 text-xl hover:bg-gray-100 rounded-l-md">-</button>
                                ...
                                <button onClick={handleIncreaseQuantity} className="quantity-btn px-4 py-2 text-xl hover:bg-gray-100 rounded-r-md">+</button>
                        ...
                        <div className="action-buttons flex flex-col sm:flex-row gap-4">
                            ...
                            <button className="btn w-full sm:w-auto flex-grow bg-white text-orange-500 border-2 border-orange-500 font-semibold py-3 px-6 rounded-md hover:bg-orange-50 transition-colors duration-300"
