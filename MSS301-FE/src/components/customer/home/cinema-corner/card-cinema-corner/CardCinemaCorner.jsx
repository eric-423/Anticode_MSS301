...
const CardCinemaCorner = () => {
  return (
    <div className="">
      <div className="w-[612px] h-[400px] rounded-[.375rem] overflow-hidden">
        <img className="object-cover" src={IMAGES.liloBlog} alt="" />
      </div>
      <div className="mt-4 ">
        <h3 className="text-[20px] cursor-pointer font-nunito-sans text-[#4a4a4a] hover:text-[#034EA2] font-bold transition-all duration-300 overflow-hidden">
...
export default CardCinemaCorner;
